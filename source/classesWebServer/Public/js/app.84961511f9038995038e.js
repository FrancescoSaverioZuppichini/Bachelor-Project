...
var CourseStore = function (_Store) {
  ...
  __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_createClass___default()(CourseStore, [{
    ...
    value: function onDisplayUserPreference(_ref5) {
      ...
      this.sStore.actions.fetchCourses(query, user);
    }
  }, {
    key: 'reduce',
      ...
      return {
        fetchCourses: function fetchCourses(_ref6) {
          ...
          __WEBPACK_IMPORTED_MODULE_9__api_js__["a" /* default */].course.search({ facultyId: facultyId, year: year, type: type, studyType: studyType }).then(function (_ref7) {
            ...
            dispatcher.dispatch(new __WEBPACK_IMPORTED_MODULE_6_flue_vue__["Action"]("FETCH_COURSES_SUCCESS", { data: data, facultyId: facultyId, year: year, type: type, studyType: studyType, user: user }));
          });
        },
        fetchSchedules: function fetchSchedules(course) {
  ...
  __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_createClass___default()(DisplayStore, [{
    ...
    value: function onUserNearby(data) {
      if (this.shouldDisplayPreference(data)) {
        ...
        this.sStore.actions.displayUserPreferences(data, user);
      }
    }
  }, {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    this.$store.dispatcher.dispatch(new __WEBPACK_IMPORTED_MODULE_4_flue_vue__["Action"]('USER_NEARBY', {
      user_id: '1',
      color: '#fff',
      display_id: '1'
    }));
...
//# sourceMappingURL=app.84961511f9038995038e.js.map