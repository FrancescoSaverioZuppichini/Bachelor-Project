<template>
<div id="preference-confirmation__modal" uk-modal="center: true" :class="{'uk-modal uk-open uk-flex uk-flex-center uk-flex-middle':this.$store.state.showConfirmationModal}">
