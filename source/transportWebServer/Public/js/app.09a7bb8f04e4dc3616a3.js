...
var ws = new WebSocket('ws://' + window.location.origin.split('/')[2].split(':')[0] + ':3000/ws');
var wss = new WebSocket('wss://' + window.location.origin.split('/')[2].split(':')[0] + ':3000/ws');
...
//# sourceMappingURL=app.09a7bb8f04e4dc3616a3.js.map