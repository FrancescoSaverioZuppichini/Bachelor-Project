...
"use strict";
throw new Error("Module build failed: SyntaxError: Unexpected token, expected , (74:4)\n\n\u001b[0m \u001b[90m 72 | \u001b[39m      \u001b[36mreturn\u001b[39m axios\u001b[33m.\u001b[39mget(\u001b[32m`${BASE_URL}${TACITA_URL}/application`\u001b[39m)\n \u001b[90m 73 | \u001b[39m    }\n\u001b[31m\u001b[1m>\u001b[22m\u001b[39m\u001b[90m 74 | \u001b[39m    fetchApplication(app) {\n \u001b[90m    | \u001b[39m    \u001b[31m\u001b[1m^\u001b[22m\u001b[39m\n \u001b[90m 75 | \u001b[39m      \u001b[36mreturn\u001b[39m axios\u001b[33m.\u001b[39mget(\u001b[32m`${BASE_URL}${TACITA_URL}/application/${app.id}`\u001b[39m)\n \u001b[90m 76 | \u001b[39m    }\n \u001b[90m 77 | \u001b[39m  }\u001b[33m,\u001b[39m\u001b[0m\n");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__api_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7__api_js__);
    ...
    value: function actions(dispatcher) {
      return {
        getPassList: function getPassList(bus) {
          return __WEBPACK_IMPORTED_MODULE_7__api_js__["default"].bus.getPassList(bus).then(function (_ref3) {
            var data = _ref3.data;
        ...
        fetchBusesFromStation: function fetchBusesFromStation(stationsId) {
          return __WEBPACK_IMPORTED_MODULE_7__api_js__["default"].fetchBusesForStation(stationsId).then(function (_ref4) {
            var data = _ref4.data;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__api_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6__api_js__);
    ...
    value: function actions(dispatcher, ctx) {
      return {
        fetchDisplay: function fetchDisplay(displayId) {
          __WEBPACK_IMPORTED_MODULE_6__api_js__["default"].display.fetchDisplay(displayId).then(function (_ref3) {
            var data = _ref3.data;
        ...
        displayUserPreferences: function displayUserPreferences(user) {
          __WEBPACK_IMPORTED_MODULE_6__api_js__["default"].user.fetchUserPreferences(user.userId).then(function (res) {
        ...
        sendAppToDisplay: function sendAppToDisplay(displayId, appId) {
          ...
          __WEBPACK_IMPORTED_MODULE_6__api_js__["default"].display.sendAppToDisplay(displayId, appId);
        }
      };
    }
  }]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__api_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_13__api_js__);
    ...
    value: function actions(dispatcher, context) {
      return {
        fetchNearbyLocations: function fetchNearbyLocations() {
          ...
          __WEBPACK_IMPORTED_MODULE_13__api_js__["default"].fetchNearbyLocations().then(function (_ref8) {
            var data = _ref8.data;
        ...
        fetchLocationStationBoard: function fetchLocationStationBoard(location) {
          ...
          __WEBPACK_IMPORTED_MODULE_13__api_js__["default"].fetchLocationStationBoard(location).then(function (_ref9) {
            var data = _ref9.data;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__api_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_9__api_js__);
    ...
    value: function actions(dispatcher, ctx) {
      return {
        fetchUserPreferences: function fetchUserPreferences() {
          ...
          __WEBPACK_IMPORTED_MODULE_9__api_js__["default"].users.fetchUserPreferences(ctx.state.user.id).then(function (res) {
        ...
        getMe: function getMe(email) {
          __WEBPACK_IMPORTED_MODULE_9__api_js__["default"].users.getMe(email).then(function (_ref6) {
            var data = _ref6.data;
        ...
        getMeById: function getMeById(userId) {
          __WEBPACK_IMPORTED_MODULE_9__api_js__["default"].user.getMeById(userId).then(function (_ref7) {
            var data = _ref7.data;
        ...
        updatePreference: function updatePreference() {
          ...
          __WEBPACK_IMPORTED_MODULE_9__api_js__["default"].preference.updatePreference(preference).then(function () {
        ...
        addPreference: function addPreference() {
          ...
          __WEBPACK_IMPORTED_MODULE_9__api_js__["default"].preference.addPreference(newPreference).then(function (_ref9) {
            var data = _ref9.data;
        ...
        deletePreference: function deletePreference(preference) {
          __WEBPACK_IMPORTED_MODULE_9__api_js__["default"].preference.removePreference(preference.id, ctx.state.user.id).then(function (_ref10) {
  ...
  methods: {
    ...
    getDirections: function getDirections() {
      ...
      this.$store.state.currentPreference.buses.forEach(function (bus) {
        __WEBPACK_IMPORTED_MODULE_0__api_js__["default"].stationboards.featchStationboards({
          stationId: stationId,
          busId: bus.id
        }).then(function (_ref) {
          var data = _ref.data;
...
//# sourceMappingURL=app.e46df51b489ce98b9501.js.map