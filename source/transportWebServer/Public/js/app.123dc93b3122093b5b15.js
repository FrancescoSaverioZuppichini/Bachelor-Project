...
var TransportDisplayStore = {
  onFetchDisplaySuccess: function onFetchDisplaySuccess(_ref5) {
    var _this4 = this;
    ...
    __WEBPACK_IMPORTED_MODULE_8__utils_js__["a" /* default */].getCurrentPosition().then(function (_ref6) {
      ...
      __WEBPACK_IMPORTED_MODULE_5_vue___default.a.set(_this4.state.display, 'coords', {});
      __WEBPACK_IMPORTED_MODULE_5_vue___default.a.set(_this4.state.display.coords, 'latitude', coords.latitude);
      __WEBPACK_IMPORTED_MODULE_5_vue___default.a.set(_this4.state.display.coords, 'longitude', coords.longitude);
    });
  },
...
//# sourceMappingURL=app.123dc93b3122093b5b15.js.map