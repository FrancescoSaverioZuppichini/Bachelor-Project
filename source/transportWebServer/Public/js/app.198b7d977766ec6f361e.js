...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__stores_TransportDisplayStore_js__ = __webpack_require__(404);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_flue_vue__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_flue_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_8_flue_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__socket_js__ = __webpack_require__(191);
...
var TransportDisplayStore = function (_Store) {
  ...
  __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_createClass___default()(TransportDisplayStore, [{
    ...
    value: function onFetchDisplaySuccess(_ref) {
      ...
      utils.getCurrentPosition().then(function (_ref2) {
        var coords = _ref2.coords;

        Vue.set(_this2.state.display, 'coords', {});
        Vue.set(_this2.state.display.coords, 'latitude', coords.latitude);
        Vue.set(_this2.state.display.coords, 'longitude', coords.longitude);
      });
    }
  }, {
    key: 'reduce',
...
/* unused harmony default export */ var _unused_webpack_default_export = (transportDisplayStore);

/***/ })
],[245]);
//# sourceMappingURL=app.198b7d977766ec6f361e.js.map