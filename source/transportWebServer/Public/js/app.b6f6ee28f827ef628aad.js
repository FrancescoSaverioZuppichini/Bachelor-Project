...
var TransportDisplayStore = function (_Store2) {
  __WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_inherits___default()(TransportDisplayStore, _Store2);
  ...
  function TransportDisplayStore() {
    ...
    var _this4 = __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_possibleConstructorReturn___default()(this, (TransportDisplayStore.__proto__ || __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_get_prototype_of___default()(TransportDisplayStore)).call(this));

    _this4.state.display = {};
    _this4.state.usersCache = {};
    _this4.state.coords = {};
  ...
  __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_createClass___default()(TransportDisplayStore, [{
    key: 'onFetchDisplaySuccess',
    value: function onFetchDisplaySuccess(_ref5) {
      var _this5 = this;

      var display = _ref5.display;

      __WEBPACK_IMPORTED_MODULE_8__utils_js__["a" /* default */].getCurrentPosition().then(function (_ref6) {
        var coords = _ref6.coords;

        __WEBPACK_IMPORTED_MODULE_5_vue___default.a.set(_this5.state.display, 'coords', {});
        __WEBPACK_IMPORTED_MODULE_5_vue___default.a.set(_this5.state.display.coords, 'latitude', coords.latitude);
        __WEBPACK_IMPORTED_MODULE_5_vue___default.a.set(_this5.state.display.coords, 'longitude', coords.longitude);
      });
    }
  }, {
    key: 'reduce',
...
//# sourceMappingURL=app.b6f6ee28f827ef628aad.js.map