...
<v-btn  icon  @click.native="triggerPageAdvance('backward')" class="grey--text text--darken-2 VueCarousel-navigation-button VueCarousel-navigation-prev btn--huge">
  <v-icon  class='icon--huge ' >keyboard_arrow_left</v-icon>
    ...
    <!-- <a href="#"
      ...
      v-html="nextLabel"></a> -->
      <v-btn icon  @click.native="triggerPageAdvance()" class="grey--text text--darken-2 VueCarousel-navigation-button VueCarousel-navigation-next btn--huge">
