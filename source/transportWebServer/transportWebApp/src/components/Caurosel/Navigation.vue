...
<div class="VueCarousel-navigation">
  <v-btn icon @click.native="triggerPageAdvance('backward')" class="grey--text text--darken-2 VueCarousel-navigation-button VueCarousel-navigation-prev btn--huge" :disabled="!canAdvanceBackward">
    <v-icon class='icon--huge '>keyboard_arrow_left</v-icon>
  </v-btn>
  <!-- <a href="#"
  ...
  <!-- <a href="#"
      ...
      v-html="nextLabel"></a> -->
  <v-btn icon @click.native="triggerPageAdvance()" class="grey--text text--darken-2 VueCarousel-navigation-button VueCarousel-navigation-next btn--huge" :disabled="!canAdvanceForward">
    <v-icon class='icon--huge'>keyboard_arrow_right</v-icon>
  </v-btn>
</div>
</template>
