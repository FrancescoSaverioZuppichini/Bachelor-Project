  ...
  <transition name="fade">
    <div class="card">
      <div class="card-block">
        ...
        <button href="#" type="button" class="btn btn-primary" @click="showStationWithInformation"
                v-else> leaving soon
        </button>
      </div>
    </div>
...
//          show the location on the leavingSoon
        this.$store.locationStore.triggerLocation(this.station)
//        get the data
        this.$store.locationStore.getStationBoard(this.station)
      }
    }
  }
</script>
