...
var colors = ['#F44336', '#E91E63', '#9C27B0', '#673AB7', '#3F51B5', '#2196F3', '#03A9F4', '#00BCD4', '#009688', '#4CAF50', '#FFEB3B', '#FF9800', '#795548', '#607D8B'];
    ...
    nativeOn: {
      "click": function($event) {
        _vm.$router.push({
          name: 'Preference',
          params: {
            src: this.window.location.origin + '/' + _vm.application.url
          }
        })
      }
    }
...
//# sourceMappingURL=app.3d4110891f72eb27757b.js.map