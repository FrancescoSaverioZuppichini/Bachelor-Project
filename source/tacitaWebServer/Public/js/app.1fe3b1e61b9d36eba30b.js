...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_object_get_prototype_of__ = __webpack_require__(30);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_vue__ = __webpack_require__(13);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_vue__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__router_index_js__ = __webpack_require__(26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__socket_js__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_flue_vue__ = __webpack_require__(17);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__api_js__ = __webpack_require__(29);
...
var DisplayStore = function (_Store) {
  ...
  __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_createClass___default()(DisplayStore, [{
    ...
    value: function addBeacon(display) {
      ...
      __WEBPACK_IMPORTED_MODULE_6_vue__["default"].set(display, 'beacons', function () {
    ...
    value: function onToogleDisplayApplicationsEdit(_ref5) {
      ...
      console.log(display);
      if (display.editApplications == undefined) __WEBPACK_IMPORTED_MODULE_6_vue__["default"].set(display, 'editApplications', false);
    ...
    value: function actions(dispatcher, ctx) {
      return {
        fetchDisplays: function fetchDisplays() {
          __WEBPACK_IMPORTED_MODULE_10__api_js__["a" /* default */].display.fetchDisplays('all').then(function (data) {
            return dispatcher.dispatch(new __WEBPACK_IMPORTED_MODULE_9_flue_vue__["Action"]('FETCH_DISPLAYS_SUCCESS', data));
          });
        },
        createDisplay: function createDisplay(display) {
          __WEBPACK_IMPORTED_MODULE_10__api_js__["a" /* default */].display.createDisplay(display).then(function (data) {
            return dispatcher.dispatch(new __WEBPACK_IMPORTED_MODULE_9_flue_vue__["Action"]('CREATE_DISPLAY_SUCCESS', data));
          });
        },
        deleteDisplay: function deleteDisplay(display) {
          __WEBPACK_IMPORTED_MODULE_10__api_js__["a" /* default */].display.deteleDisplay(display).then(function () {
            return dispatcher.dispatch(new __WEBPACK_IMPORTED_MODULE_9_flue_vue__["Action"]('DELETE_DISPLAY_SUCCESS', { display: display }));
          });
        },
        changeApp: function changeApp(display, app) {
          return __WEBPACK_IMPORTED_MODULE_10__api_js__["a" /* default */].display.changeApp(display, app).then(function (data) {
            return dispatcher.dispatch(new __WEBPACK_IMPORTED_MODULE_9_flue_vue__["Action"]("CHANGE_DISPLAY_APP_SUCCESS", { display: display, app: app }));
          }).catch(function (err) {
            return console.log(err);
          });
        },
        toogleDisplayApplicationsEdit: function toogleDisplayApplicationsEdit(display) {
          dispatcher.dispatch(new __WEBPACK_IMPORTED_MODULE_9_flue_vue__["Action"]('TOOGLE_DISPLAY_APPLICATIONS_EDIT', { display: display }));
        }
      };
    }
  }]);
      ...
      return {
        ...
        createApplication: function createApplication(app) {
          return __WEBPACK_IMPORTED_MODULE_8__api_js__["a" /* default */].application.createApplication(app).then(function (data) {
            return dispatcher.dispatch(new __WEBPACK_IMPORTED_MODULE_6_flue_vue__["Action"]("CREATE_APPLICATION_SUCCESS", data));
          }).catch(function (err) {
            return console.log(err);
          });
        },
        ...
        removeApplication: function removeApplication(app) {
          return __WEBPACK_IMPORTED_MODULE_8__api_js__["a" /* default */].application.removeApplication(app).then(function (data) {
            return dispatcher.dispatch(new __WEBPACK_IMPORTED_MODULE_6_flue_vue__["Action"]("REMOVE_APPLICATION_SUCCESS", { app: app }));
          }).catch(function (err) {
            return console.log(err);
          });
        }
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Page_Page_vue__ = __webpack_require__(49);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Resources_ResourcesWrapper_vue__ = __webpack_require__(50);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Resources_ResourcesWrapper_vue__ = __webpack_require__(50);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Page_Page_vue__ = __webpack_require__(49);
...
window.jQuery = window.$ = __webpack_require__(52);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('page', {
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.newApplication.materialIcon),
      expression: "newApplication.materialIcon"
    }],
    staticClass: "uk-input uk-margin-bottom",
    attrs: {
      "type": "text",
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.newApplication.materialIcon = $event.target.value
      }
    }
  }), _vm._v(" "), _c('input', {
    directives: [{
    ...
    nativeOn: {
      "click": function($event) {
        _vm.$store.actions.createApplication(_vm.newApplication)
      }
    }
  }, [_vm._v("Yes")])], 1)])])])], 1)
},staticRenderFns: []}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('resource', [_c('div', {
  ...
  }, [_vm._v("Remove")])]), _vm._v(" "), _c('li', [_c('a', [_vm._v("Edit")])])])])], 1), _vm._v(" "), _c('div', {
    staticClass: "uk-flex"
    ...
    nativeOn: {
      "click": function($event) {
        _vm.$store.actions.toogleDisplayApplicationsEdit(_vm.data)
      }
    }
  ...
  }, [_c('v-icon', [_vm._v("keyboard_arrow_up")])], 1)], 2), _vm._v(" "), (_vm.data.editApplications) ? _c('div', [_vm._v("\n      Change application\n      "), _c('div', {
    staticClass: "uk-flex"
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('resource', [_c('div', {
    ...
    on: {
      "click": function($event) {
        _vm.$store.actions.deleteApplication(_vm.data)
      }
    }
  }, [_vm._v("Remove")])]), _vm._v(" "), _c('li', [_c('a', {
    on: {
...
//# sourceMappingURL=app.1fe3b1e61b9d36eba30b.js.map