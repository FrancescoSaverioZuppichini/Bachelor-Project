...
\begin{figure}[H]
  \centering
  \subfloat[]{\includegraphics[width=0.4\textwidth]{./images/new_york_displays.jpg}}
  \hfill
  \subfloat[]{\includegraphics[width=0.45\textwidth]{./images/piccadilly_displays.jpg}}
\end{figure} 
...
\begin{figure}[H]
  \centering
  \subfloat[]{\includegraphics[width=0.4\textwidth]{./images/new_york_posters.jpg}}
\end{figure} 
