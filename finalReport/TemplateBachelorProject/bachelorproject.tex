...
\begin{figure}[H]
  \centering
  \subfloat[Beacon found]{\includegraphics[width=0.25\textwidth]{./images/tacita_display_found}}
   \
  \
  \
  \subfloat[Display found]{\includegraphics[width=0.25\textwidth]{./images/tacita_display_view}}
\end{figure}
...
\begin{figure}[H]
  \centering
  \subfloat[Select a colour]{\includegraphics[width=0.25\textwidth]{./images/preference_colour/colour_select}}
   \
  \
  \
  \subfloat[Personalization page]{\includegraphics[width=0.25\textwidth]{./images/preference_colour/personalization_page}}
     \
  \
  \
