...
\abstract {
Nowadays displays are mostly used to show static information to huge amount of people by using a passive and unilateral communication channel. With our application, \emph{Tacita}, we reshape that channel by creating a bilateral relationship between the user and the screen providing in-walk personalised content.
...
\begin{figure}[H]
  \centering
  \subfloat[User interactions]{\includegraphics[width=0.5\textwidth]{./images/user_interactions.jpeg}}
...
\begin{figure}[H]
  \centering
  \subfloat[Loading]{\includegraphics[width=0.2\textwidth]{./images/tacita_skeletron}}
  \
  \subfloat[Finish]{\includegraphics[width=0.2\textwidth]{./images/tacita_main}}
  \
    \subfloat[Beacon found]{\includegraphics[width=0.205\textwidth]{./images/tacita_display_found}}
    \
  \subfloat[Display found]{\includegraphics[width=0.205\textwidth]{./images/tacita_display_view}}

\end{figure}
%
%\begin{figure}[H]
%  \centering
%  \subfloat[Beacon found]{\includegraphics[width=0.2\textwidth]{./images/tacita_display_found}}
%   \
%  \
%  \
%  \subfloat[Display found]{\includegraphics[width=0.2\textwidth]{./images/tacita_display_view}}
%\end{figure}
...
\begin{figure}[H]
  \centering
  \subfloat[Select a colour]{\includegraphics[width=0.22\textwidth]{./images/preference_colour/colour_select}}
   \
  \
  \
  \subfloat[Personalization page]{\includegraphics[width=0.22\textwidth]{./images/preference_colour/personalization_page}}
     \
  \
  \
    \subfloat[Appearence on a display]{\includegraphics[width=0.25\textwidth]{./images/preference_colour/result}}
\end{figure}
...
\begin{figure}[H]
  \centering
  \subfloat[More users]{\includegraphics[width=0.25\textwidth]{./images/preference_colour/result_splitted}}
\end{figure}
